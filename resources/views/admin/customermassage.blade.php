    ...
    <div class="app-content-header mb-4">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h3 class="mb-0 text-dark fw-bold" style="font-size: 1.6rem;">Customer Messages</h3>
                    <p class="text-muted small mb-0">Manage, edit, and track customer messages.</p>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end mb-0 bg-transparent p-0">
                        <li class="breadcrumb-item"><a href="#" class="text-decoration-none text-secondary">Dashboard</a></li>
                        <li class="breadcrumb-item active fw-medium" aria-current="page">Message List</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-white border-0 py-3.5 d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <h5 class="card-title mb-0 fw-bold text-dark" style="font-size: 1.1rem;">All Messages</h5>
                            </div>
                        </div>
                                ...
                                <table class="table align-middle mb-0" style="table-layout: fixed; width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-start py-3" style="width: 140px;">Name</th>
                                            <th class="text-start py-3" style="width: 130px;">Phone</th>
                                            <th class="text-start py-3" style="width: 180px;">Email</th>
                                            <th class="text-start py-3" style="width: 200px;">Subject</th>
                                            <th class="text-start py-3" style="min-width: 250px;">Message</th>
                                    ...
                                    <tbody>
                                        @forelse($massages as $massage)
                                            <tr>
                                                ...
                                                <td class="text-start">
                                                    <span class="fw-bold text-dark d-block text-truncate" title="{{ $massage->name }}">
                                                        {{ $massage->name }}
                                                    </span>
                                                </td>
                                                <td class="text-start">
                                                    <span class="text-secondary d-block text-truncate" title="{{ $massage->phone }}">
                                                        {{ $massage->phone }}
                                                    </span>
                                                </td>
                                                <td class="text-start">
                                                    <span class="text-secondary d-block text-truncate" title="{{ $massage->email }}">
                                                        {{ $massage->email }}
                                                    </span>
                                                </td>
                                                <td class="text-start">
                                                    <span class="fw-semibold text-dark d-block text-truncate" title="{{ $massage->subject }}">
                                                        {{ $massage->subject }}
                                                    </span>
                                                </td>
                                                <td class="text-start">
                                                    <span class="text-muted d-block text-truncate" title="{{ $massage->massage }}">
                                                        {{ $massage->massage }}
                                                    </span>
                                                </td>
