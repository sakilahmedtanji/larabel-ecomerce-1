                ...
                <div class="col-md-8 col-12">
                    ...
                    <div class="card shadow-sm border-0 rounded-3">
                        <div class="card-header bg-white border-bottom py-3 d-flex align-items-center">
                            ...
                            <h5 class="card-title mb-0 fw-semibold text-secondary">Edit Review</h5>
                        </div>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="product_id" id="product_id" class="form-select shadow-none" required>
                                        ...
                                        @foreach ($products as $product)
                                            <option value="{{ $product->id }}" @if ($product->id == $reviews->product_id)
                                                selected
                                            @endif >
                                                {{ $product->name }}
                                            </option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control shadow-none" id="customer_name" name="customer_name" 
                                           value="{{$reviews->customer_name}}" placeholder="e.g." required />
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control shadow-none" id="comment" name="comment" 
                                           value="{{$reviews->comment}}" placeholder="e.g." required />
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control shadow-none" id="ratting" name="ratting" 
                                           value="{{$reviews->ratting}}" placeholder="e.g." required />
                                </div>
                                ...
                                @if ($reviews->image != null)
                                    <img src="{{$reviews->image}}" height="100" width="80" alt="">
