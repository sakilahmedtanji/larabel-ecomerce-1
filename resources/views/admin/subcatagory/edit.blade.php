            ...
            <div class="row g-4">
              ...
              <div class="col-md-12">
                ...
                <div class="card card-primary card-outline mb-4">
                  ...
                  <!--end::Header-->
                  <!--begin::Form-->
                  <form method="POST" action="{{url('/product/subcatagory-manage/post/upate/'.$subcatagory->id)}}" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Body-->
                    <div class="card-body">
                        <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="{{$subcatagory->name}}" id="name" name="name" />
                      </div>
