                ...
                <div class="col-sm-6">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-muted small mb-0">Modify, re-assign, and update sub-category details</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card shadow-xs border border-light-subtle rounded-4 overflow-hidden mb-4">
                        <div class="card-header bg-white border-bottom border-light-subtle py-3 d-flex align-items-center justify-content-between flex-wrap gap-2">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <h5 class="card-title mb-0 fw-bold text-dark fs-6">Update Sub-Category: <span class="text-primary">{{ $subcatagory->name }}</span></h5>
                            </div>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group custom-input-group">
                                        ...
                                        <select name="cat_id" id="cat_id" class="form-select fs-7 border-light-subtle shadow-none" required>
                                            ...
                                            @foreach ($catagory as $catagories)
                                                <option value="{{ $catagories->id }}" {{ (old('cat_id', $subcatagory->cat_id) == $catagories->id) ? 'selected' : '' }}>
                                                    {{ $catagories->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <small class="text-muted fs-8 mt-1.5 d-block">
                                        <i class="bi bi-info-circle me-1 text-primary"></i> Modify the primary category under which this item is listed.
                                    </small>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group custom-input-group">
                                        ...
                                        <input type="text" class="form-control fs-7 border-light-subtle shadow-none" 
                                               id="name" name="name" 
                                               value="{{ old('name', $subcatagory->name) }}" 
                                               placeholder="e.g. Wireless Headphones, T-Shirts" required />
                                    </div>
                                    <small class="text-muted fs-8 mt-1.5 d-block">
                                        Update the name of this sub-category.
                                    </small>
